...
erlang: get-deps clean-ebin
	...
	@which rebar3.cmd >/dev/null 2>&1 && rebar3.cmd compile || rebar3 compile
# 	@ERL_LIBS=$(ERL_LIBS) \
	PATH=$(SCRIPT_PATH):deps/lfe/bin lfec -o $(OUT_DIR) src/lfe/*.lfe
	@cp src/lfe/lfecljapp.app.src ebin/lfecljapp.app
...
clean: clean-ebin clean-eunit
	@-which rebar3.cmd >/dev/null 2>&1 && rebar3.cmd clean || rebar3 clean
	-rm priv/*.jar
	-rm erl_crash.dump
